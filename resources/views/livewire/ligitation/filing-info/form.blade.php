                ...
                <form class="patient-info-detail-form" wire:submit.prevent="submitLeftForm">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="filing_date" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['filing_date']}}" name="filing_date" wire:model.defer="leftForm.filing_date" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="amended_filing" class="col-4 col-form-label">Amended Filing</label>
                            <div class="col-7">
                                <input id="amended_filing" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['amended_filing']}}" name="amended_filing" wire:model.defer="leftForm.amended_filing" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="date_served" class="col-4 col-form-label">Date Served</label>
                            <div class="col-7">
                                <input id="date_served" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['date_served']}}" name="date_served" wire:model.defer="leftForm.date_served" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="aos_filing_date" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['aos_filing_date']}}" name="aos_filing_date" wire:model.defer="leftForm.aos_filing_date" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="service_complete" class="col-4 col-form-label">Service Complete</label>
                            <div class="col-7">
                                <input id="service_complete" readonly value="{{@$filing_info['service_complete']}}" name="service_complete" wire:model.defer="leftForm.service_complete" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="ans_ext" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['ans_ext']}}" name="ans_ext" wire:model.defer="leftForm.ans_ext" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="ans_rec" class="col-4 col-form-label">Answer Rec.</label>
                            <div class="col-7">
                                <input id="ans_rec" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['ans_rec']}}" name="ans_rec" wire:model.defer="leftForm.ans_rec" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="default_letter" class="col-4 col-form-label">Default Letter</label>
                            <div class="col-7">
                                <input id="default_letter" readonly value="{{@$filing_info['default_letter']}}" name="default_letter" wire:model.defer="leftForm.default_letter" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="default_date" @if($leftFormStatus=="readonly" ) readonly @endif value="{{@$filing_info['default_date']}}" name="default_date" wire:model.defer="leftForm.default_date" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="default_deadline" class="col-4 col-form-label">Def. Vac. Deadline</label>
                            <div class="col-7">
                                <input id="default_deadline" readonly value="{{@$filing_info['default_deadline']}}" name="default_deadline" wire:model.defer="leftForm.default_deadline" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-edit-button general-form-edit">
                        <div class="form-group row">
                            ...
                            <div class="add-del-button col-4">
                                ...
                                <button wire:click.prevent="editable('left')" @if(empty($filing_info)) disabled @endif id="update-left-button" type="button" class="btn d-flex  justify-content-between"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <g clip-path="url(#clip0_956_2256)">
                ...
                <form class="form" wire:submit.prevent="submitRightForm">
                    ...
                    <div class="form-data row">
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="d_demands" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_demands']}}" name="d_demands" wire:model.defer="rightForm.d_demands" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_resp" class="col-4 col-form-label">P. Resp.</label>
                            <div class="col-7">
                                <input id="p_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_resp']}}" name="p_resp" wire:model.defer="rightForm.p_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_demands" class="col-4 col-form-label">P. Demands.</label>
                            <div class="col-7">
                                <input id="p_demands" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_demands']}}" name="p_demands" wire:model.defer="rightForm.p_demands" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="d_resp" class="col-4 col-form-label">D. Resp.</label>
                            <div class="col-7">
                                <input id="d_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_resp']}}" name="d_resp" wire:model.defer="rightForm.d_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="d_3101" class="col-4 col-form-label">D 3101(d)</label>
                            <div class="col-7">
                                <input id="d_3101" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_3101']}}" name="d_3101" wire:model.defer="rightForm.d_3101" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_3101" class="col-4 col-form-label">P 3101(d)</label>
                            <div class="col-7">
                                <input id="p_3101" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_3101']}}" name="p_3101" wire:model.defer="rightForm.p_3101" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="d_notice" class="col-4 col-form-label">D. Notice to Admit</label>
                            <div class="col-7">
                                <input id="d_notice" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_notice']}}" name="d_notice" wire:model.defer="rightForm.d_notice" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_nta_resp" class="col-4 col-form-label">P. NTA Resp.</label>
                            <div class="col-7">
                                <input id="p_nta_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_nta_resp']}}" name="p_nta_resp" wire:model.defer="rightForm.p_nta_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_notice" class="col-4 col-form-label">P. Notice to Admit</label>
                            <div class="col-7">
                                <input id="p_notice" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_notice']}}" name="p_notice" wire:model.defer="rightForm.p_notice" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="d_nta_resp" class="col-4 col-form-label">D. NTA Resp.</label>
                            <div class="col-7">
                                <input id="d_nta_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_nta_resp']}}" name="d_nta_resp" wire:model.defer="rightForm.d_nta_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="good_faith_let" class="col-4 col-form-label">Good Faith Let.</label>
                            <div class="col-7">
                                <input id="good_faith_let" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['good_faith_let']}}" name="good_faith_let" wire:model.defer="rightForm.good_faith_let" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="note_of_issue" class="col-4 col-form-label">Note of Issue</label>
                            <div class="col-7">
                                <input id="note_of_issue" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['note_of_issue']}}" name="note_of_issue" wire:model.defer="rightForm.note_of_issue" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="d_supp_demand" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_supp_demand']}}" name="d_supp_demand" wire:model.defer="rightForm.d_supp_demand" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_supp_resp" class="col-4 col-form-label">P Supp. Resp.</label>
                            <div class="col-7">
                                <input id="p_supp_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_supp_resp']}}" name="p_supp_resp" wire:model.defer="rightForm.p_supp_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="p_supp_demand" class="col-4 col-form-label">P Supp. Demand</label>
                            <div class="col-7">
                                <input id="p_supp_demand" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['p_supp_demand']}}" name="p_supp_demand" wire:model.defer="rightForm.p_supp_demand" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label for="d_supp_resp" class="col-4 col-form-label">D. Supp. Resp.</label>
                            <div class="col-7">
                                <input id="d_supp_resp" @if($rightFormStatus=="readonly" ) readonly @endif value="{{@$discovery['d_supp_resp']}}" name="d_supp_resp" wire:model.defer="rightForm.d_supp_resp" type="text" class="form-control filing-form-datepicker">
                            </div>
                        </div>
                        <div class="form-group row col-6">
                            <label class="col-4 col-form-label">3rd Party Discv.</label>
                            <div class="col-7">
                                <input placeholder="date field" @if($rightFormStatus=="readonly" ) readonly @endif name="party_disc_date" value="{{@$discovery['party_disc_date']}}" wire:model.defer="rightForm.party_disc_date" type="text" class="form-control filing-form-datepicker">
                                <br>
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input placeholder="date field" @if($rightFormStatus=="readonly" ) readonly @endif name="subpoena_date" value="{{@$discovery['subpoena_date']}}" wire:model.defer="rightForm.subpoena_date" type="text" class="form-control filing-form-datepicker">
                                <br>
                        ...
                        <div class="form-group row col-6">
                            ...
                            <div class="col-7">
                                <input id="notes" @if($rightFormStatus=="readonly" ) readonly @endif name="notes" wire:model.defer="rightForm.notes" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    @if(!empty($basic_intake_id))
                    <div class="form-edit-button adv-form-edit">
                        <div class="form-group row">
                            ...
                            ;J0 Z nb">
                                ...
                                <button wire:click.prevent="editable('right')" @if(empty($discovery)) disabled @endif id="update-right-button" type="button" class="btn d-flex  justify-content-between"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <g clip-path="url(#clip0_956_2256)">
                                            <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" fill="#1B1D21" />
                                        </g>
                                        <defs>
                                ...
                                <form wire:submit.prevent="submitScheduleForm" id="scheduleForm">
                                    <div class="form-fields row">
                                        ...
                                        <div class="form-group col-6 d-flex">
                                            ...
                                            <div class="col-8">
                                                <input id="demand_due" name="demand_due" wire:model.defer="modalData.demand_due" type="text" class="form-control filing-form-datepicker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-5 d-flex">
                                            ...
                                            <div class="col-8">
                                                <input id="resp_due" name="resp_due" wire:model.defer="modalData.resp_due" type="text" class="form-control filing-form-datepicker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6 d-flex">
                                            ...
                                            <div class="col-8">
                                                <input id="ebt_deadlines" name="ebt_deadlines" wire:model.defer="modalData.ebt_deadlines" type="text" class="form-control filing-form-datepicker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-5 d-flex">
                                            ...
                                            <div class="col-8">
                                                <input id="next_desc_conf" name="next_desc_conf" wire:model.defer="modalData.next_desc_conf" type="text" class="form-control filing-form-datepicker">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6 d-flex">
                                            ...
                                            <div class="col-8">
                                                <input id="noi_due" name="noi_due" wire:model.defer="modalData.noi_due" type="text" class="form-control filing-form-datepicker">
                                            </div>
                                        </div>
                                    </div>
