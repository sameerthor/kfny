<div>
    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row col-4">
                                ...
                                <div class="col-7">
                                    ...
                                    <span>{{ (@$settlementForm['new_total']=="1"?@$settlementForm['new_principle']:@$settlementForm['principle_amount']) + @$settlementForm['interest_amount'] + @$settlementForm['attorney_fees'] +@$settlementForm['filing_fees'] + @$settlementForm['costs'] }}</span>
                                </div>
                            </div>
                            <div class="form-group row col-4">
                            </div>
        ...
        <div style="float:right;">Total Outstanding-<span>{{max((int)((@$settlementForm['new_total']=="1"?@$settlementForm['new_principle']:@$settlementForm['principle_amount']) + @$settlementForm['interest_amount'] + @$settlementForm['attorney_fees'] +@$settlementForm['filing_fees'] + @$settlementForm['costs'])-$settlementChecks->sum('total'), 0)}}</span></div>
