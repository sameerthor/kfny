                        ...
                        <tbody id="r1">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-dark" wire:click.prevent="editBill({{$res['id']}})" type="button" id="view-bill-{{$res['id']}}">
                                    ...
                                    <button class="btn sky-btn" onclick="confirm('Are you sure you want to delete this bill?') || event.stopImmediatePropagation()" wire:click="deleteBill({{$res['id']}})" id="delete-bill"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
