...
<div class="modal fade" id="editDefenceModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Defence Firm</h1>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal_main_body">
        <form id="editdefenseFirmForm">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="firm_name" value="{{$info['firm_name']}}" id="firm_name" data-rule-required="true">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary update-defence" data-url="{{route('defense-firm.update',$info['id'])}}">SUBMIT</button>
          </div>
        </form>
