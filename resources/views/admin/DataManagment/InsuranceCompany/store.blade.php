...
<div class="modal fade" id="addInsurance" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Insurance Company</h1>
      ...
      <div class="modal_main_body">
        <form id="insuranceForm">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control " name="insurance_company" id="insurance_company" data-rule-required="true">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary save-insurance" data-url="{{route('insurance-company.store')}}">SUBMIT</button>
          </div>
        </form>
