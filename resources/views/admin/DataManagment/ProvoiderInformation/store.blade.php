        ...
        <div class="modal_main_body">
          <form id="provoiderInformationForm">
            <div class="modal-body">
              ...
              <input type="checkbox" id="user_credential" name="user_credential" value="1">
              <label for="user_credential">Create Credentials</label><br>
              <div class="row" style="display: none;" id="user_credential_box">
