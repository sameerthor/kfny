...
<html lang="en">
  <head>
    ...
    <link
      ...
      crossorigin="anonymous"
    />
    <link rel="stylesheet" href="../Publice/Style/Css/kfnythemes.css" />
    <link rel="stylesheet" href="../Publice/Style/Css/pages.css" />
  </head>
  <body>
                  ...
                  <div class="menu_icon">
                    ...
                    >
                      <g clip-path="url(#clip0_75_725)">
                        <path
                          d="M17.5 2.49334V17.5067C17.4983 17.7255 17.4105 17.9349 17.2557 18.0896C17.1008 18.2443 16.8914 18.3318 16.6725 18.3333H3.3275C3.10818 18.3333 2.89783 18.2463 2.74266 18.0913C2.5875 17.9363 2.50022 17.726 2.5 17.5067V2.49334C2.50175 2.27449 2.58951 2.06511 2.74435 1.91043C2.89918 1.75576 3.10865 1.6682 3.3275 1.66667H16.6725C17.1292 1.66667 17.5 2.03667 17.5 2.49334ZM15.8333 3.33334H4.16667V16.6667H15.8333V3.33334ZM9.41083 10.9342L12.9467 7.39917L14.125 8.57751L9.41083 13.2917L6.16917 10.05L7.34833 8.87167L9.41083 10.9342Z"
                        />
                      </g>
                      <defs>
                  ...
                  <div class="menu_icon">
                    ...
                    >
                      <g clip-path="url(#clip0_75_754)">
                        <path
                          d="M6.66667 3.33333H17.5V5H6.66667V3.33333ZM2.5 2.91667H5V5.41667H2.5V2.91667ZM2.5 8.75H5V11.25H2.5V8.75ZM2.5 14.5833H5V17.0833H2.5V14.5833ZM6.66667 9.16667H17.5V10.8333H6.66667V9.16667ZM6.66667 15H17.5V16.6667H6.66667V15Z"
                        />
                      </g>
                      <defs>
                ...
                <div class="row">
                  <div class="col-md-9">
                    <form>
                      ...
                      <!-- first name and Insurance Company start  -->
                      ...
                      <!-- first name and Insurance Company end  -->




                      <!-- last name and Self Insured start  -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Self Insured</label>
                          </div>
                        </div>
                      </div>
                      <!-- last name and Self Insured end  -->



                      

                      <!-- Street Address and  Litigation start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Litigation</label>
                          </div>
                        </div>
                      </div>
                      <!-- Street Address and  Litigation end -->

                      <!-- City and Venue County start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Venue County</label>
                          </div>
                        </div>
                      </div>
                      <!-- City and Venue County end -->




                      <!-- Status and Venue court start -->
                      <div class="row">
                        <!-- Status  start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Venue court</label>
                          </div>
                        </div>
                      </div>
                      <!-- Status and Venue court end -->





                      <!-- Zip Code and  File  start -->
                      <div class="row">
                        <!-- Zip Code   start -->
                        <div class="col-md-6">
                          <div class="floating-label-group">
                      ...
                      <!-- Zip Code and  File  end -->



                      <!-- dob amd Index Number start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Index Number</label>
                          </div>
                        </div>
                      </div>
                      <!-- dob amd Index Number end -->




                      <!-- Contact Number and  AAA Number start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">AAA Number</label>
                          </div>
                        </div>
                      </div>

                      <!-- Contact Number and  AAA Number end -->





                      <!-- Insured Name and  Appeal Docket start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Insured Name</label>
                          </div>
                        </div>

                        <!--  Appeal Docket Appeal  start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Appeal Docket</label>
                          </div>
                        </div>
                      </div>

                      <!-- Insured Name and  Appeal Docket end -->


                      <!-- Date Of Accident and    Status start -->

                      <div class="row">

                           <!-- Date Of Accident  start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <select name="Status" id="Status" class="form-control_select">
                              <option value="volvo">Status</option>
                              <option value="saab">Saab</option>
                              <option value="mercedes">Mercedes</option>
                              <option value="audi">Audi</option>
                      ...
                      <!-- Date Of Accident and    Status end -->

                    

                      <!-- Clam No. and  Provider start -->
                        ...
                        <div class="col-md-6">
                          <div class="floating-label-group">
                            <input
                              ...
                              required
                            />
                            <label class="floating-label">Clam</label>
                          </div>
                        </div>
                           <!--  Provider start -->
                     ...
                     <!-- Clam No. and  Provider end -->

                          <!-- Policy No. and  Carrier’s Attorney  start -->
                         ...
                         <div class="col-md-6">
                           <div class="floating-label-group">
                             <input
                               ...
                               required
                             />
                             <label class="floating-label">Policy No </label>
                           </div>
                         </div>
                             <!-- Carrier’s Attorney  start -->
                         ...
                         <div class="col-md-6">
                           <div class="floating-label-group">
                             <input
                               type="text"
                               id="Carrier’sAttorney"
                               name="Carrier’sAttorney"
                               class="form-control"
                               autocomplete="off"
                               autofocus
                               required
                             />
                             <label class="floating-label">Carrier’s Attorney</label>
                           </div>
                         </div>
                       </div>
                    <!-- Policy No. and  Carrier’s Attorney  start -->
                  ...
                  <div class="col-md-3">
                    <div class="intakeinfo_right_setion">
                      <div class="intakeinfo_right_section_title">
                        Add Notes
                      </div>

                      <div class="intakeinfo_right_section_button">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
                          height="20"
                        ...
                        >
                          <path
                            d="M3.414 14L13.556 3.85802L12.142 2.44402L2 12.586V14H3.414ZM4.243 16H0V11.757L11.435 0.322022C11.6225 0.134551 11.8768 0.0292358 12.142 0.0292358C12.4072 0.0292358 12.6615 0.134551 12.849 0.322022L15.678 3.15102C15.8655 3.33855 15.9708 3.59286 15.9708 3.85802C15.9708 4.12319 15.8655 4.37749 15.678 4.56502L4.243 16ZM0 18H18V20H0V18Z"
                            fill="#7C7C7C"
                          />
                        </svg>
                      </div>
                    ...
                    <div class="inrakeinfo_rigth_section_not">
                      <textarea
                        name="tnot"
                        id="not"
                        cols="30"
    ...
    <script src="../Publice/Javascript/data.js"></script>
